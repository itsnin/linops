...
pub struct AppState {
    ...
    pub tasks: Vec<Box<dyn crate::task::Task>>,
    pub distro: Option<crate::distro::DistroId>,
    pub running: bool,
    pub log_lines: Vec<String>,
    pub current_task: Option<String>,
    pub task_progress: u8,
    pub search_query: String,
    pub search_all_items: Vec<(usize, crate::search::SearchItem)>,
    pub search_results: Vec<(usize, u32)>,
    pub search_selected: usize,
    pub width: u16,
    pub height: u16,
    pub pending_actions: Vec<crate::action::Action>,
}

// all categories in display order
pub const ALL_CATEGORIES: [crate::task::Category; 6] = [
    crate::task::Category::PackageManagement,
    crate::task::Category::SystemManagement,
    crate::task::Category::NetworkingSecurity,
    crate::task::Category::DevelopmentToolchain,
    crate::task::Category::PerformanceGaming,
    crate::task::Category::Environment,
];

impl AppState {
    pub fn new(tasks: Vec<Box<dyn crate::task::Task>>) -> Self {
        Self {
    ...
    pub fn current_category(&self) -> crate::task::Category {
    ...
    pub fn active_task(&self) -> Option<&dyn crate::task::Task> {
    ...
    pub fn active_task_mut(&mut self) -> Option<&mut dyn crate::task::Task> {
        let indices = self.tasks_in_current_category();
        if let Some(&idx) = indices.get(self.active_task) {
            let boxed: &mut Box<dyn crate::task::Task> = &mut self.tasks[idx];
    ...
    pub fn enter_search(&mut self) {
        self.mode = crate::mode::Mode::Search;
    ...
    pub fn update_search_results(&mut self) {
        ...
        let items: Vec<&crate::search::SearchItem> =
            self.search_all_items.iter().map(|(_, item)| item).collect();

        let matched = crate::search::search_results(&query, &items);
