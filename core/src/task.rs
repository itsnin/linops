...
pub trait Task: Send + Sync {
    ...
    fn supports_distro(&self, distro: &crate::distro::DistroId) -> bool;

    fn handle_key(&mut self, key: crate::key::Key) -> Vec<crate::action::Action>;
    fn render(&self, area: crate::rect::Rect, grid: &mut crate::grid::Grid);
    fn searchable_items(&self) -> Vec<crate::search::SearchItem> {
        Vec::new()
    }
}
